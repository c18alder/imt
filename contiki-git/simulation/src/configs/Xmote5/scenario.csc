...
<simconf>
  ...
  <simulation>
   ...
   <motetype>
    ...
    <mote>
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>-53.076301784795305</x>
        <y>-0.5471001630459549</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.contikimote.interfaces.ContikiMoteID
    ...
    <mote>
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>-21.880020420614652</x>
        <y>4.999878991011585</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.contikimote.interfaces.ContikiMoteID
    ...
    <mote>
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>61.99039621690141</x>
        <y>0.48986039990594143</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.contikimote.interfaces.ContikiMoteID
    ...
    <mote>
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>35.75914300865255</x>
        <y>5.670543395152979</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.contikimote.interfaces.ContikiMoteID
  ...
  <plugin>
    ...
    <plugin_config>
      ...
      <viewport>2.0346751675148598 0.0 0.0 2.0346751675148598 155.2131285229437 250.27602048148978</viewport>
    </plugin_config>
    <width>400</width>
    <z>0</z>
    <height>400</height>
