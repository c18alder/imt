/**
 * This is the implementation of the max voltage resource.
 * 
...
public class CellVoltageMaxResource extends CoapResource implements OSVFloatCoAPResource {
	private float data = 0f;

	public CellVoltageMaxResource() {

		// Set resource identifier
		super("max");

		// Set display name
		getAttributes().setTitle("Cells' maximum voltage");
	...
	public void handleGET(CoapExchange exchange) {
		...
		if (BMSServer.useName) {
			json.put("name", "Cells' maximum voltage");
		}
